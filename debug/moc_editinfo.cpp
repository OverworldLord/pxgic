...
const QMetaObject editInfo::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_editInfo.data,
      qt_meta_data_editInfo,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *editInfo::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_editInfo.stringdata0))
        return static_cast<void*>(const_cast< editInfo*>(this));
